...
public class ButtonLAF {
	...
	public static int		DEFAULT_BORDER_ROUND_RADIUS	= 20;
	...
	private int				border;
	private int				borderRoundRadius;
	private int				borderWidth;
	private Font			font;

	public ButtonLAF(Color back, Color text, Color borderColor, int border, int borderRoundRadius, int borderWidth, Font font) {

		this.back = back;
		this.text = text;
		this.borderColor = borderColor;
		this.border = border;
		this.borderRoundRadius = borderRoundRadius;
	...
	public ButtonLAF(Color back, Color text, Color borderColor, int border, int borderWidth, Font font) {
		...
		this(back, text, borderColor, border, DEFAULT_BORDER_ROUND_RADIUS, borderWidth, font);
	...
	public int getBorderRoundRadius() {
		return borderRoundRadius;
	}

	public void setBorderRoundRadius(int borderRoundRadius) {
		this.borderRoundRadius = borderRoundRadius;
	}
